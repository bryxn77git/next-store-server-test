...
const Marca: FC<Props> = ({ marca, categories }) => {
  return (
    <ShopLayout title={`${marca.name.charAt(0).toUpperCase() + marca.name.slice(1).toLowerCase()}`} pageDescription={`Encuentra los mejores productos de la marca ${marca.name} para tu empresa`} >
        <Card elevation={0}>
