...
const CategoriaAdminPage:FC<Props> = ({ ad }) => {
    ...
    return (
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={ 6 }> 
                        ...
                        <Box display='flex' flexDirection="column">
                            <FormLabel sx={{ mb:1}}>Imágenes de publicidad</FormLabel>
                            <Button
                                variant='contained'
                                fullWidth
        ...
        <Snackbar open={openAlert} onClose={() => setOpenAlert(false)} autoHideDuration={6000} sx={{ pt: { xs: 15, sm: 20}}} anchorOrigin={{ vertical: 'top', horizontal: 'right'}} >
            <Alert onClose={() => setOpenAlert(false)} severity="success" sx={{ width: '100%' }}>
                { ad._id ? 'La categoria se guardó correctamente!' : 'La categoria se creó correctamente!'}
            </Alert>
        </Snackbar>
        <Backdrop
