...
const Terminos = () => {
  return (
    <ShopLayout title='Términos y condiciones' pageDescription={'Términos y condiciones de la empresa Next Store Uniforms'} >
            ...
            >
                ...
                <Grid item xs={12} sx={{ mt: { xs: 3, md: 5} }}>
                    <Box display='flex' justifyContent='center'> 
                        <TitleUi title='TÉRMINOS Y CONDICIONES'/>  
                    </Box>
                    <Box display='flex' justifyContent='center'> 
                ...
                <Grid container spacing={3} sx={{ mt: 3, px: 3 }}>
                    ...
                    <Grid item xs={12}>
                        <TitleUi title='Limitación de responsabilidad'/>
                    </Grid>
                    <Grid item xs={12}>
                        <Typography>
                    ...
                    <Grid item xs={12}>
                        <TitleUi title='Descargo de responsabilidad "TAL CUAL" y "SEGÚN DISPONIBILIDAD"'/>
                    </Grid>
                    <Grid item xs={12}>
                        <Typography>
                    ...
                    <Grid item xs={12}>
                        <TitleUi title='Resolución de disputas'/>
                    </Grid>
                    <Grid item xs={12}>
                        <Typography>
                    ...
                    <Grid item xs={12}>
                        <TitleUi title='Divisibilidad y renuncia'/>
                    </Grid>
                    <Grid item xs={12}>
                    ...
                    <Grid item xs={12}>
                        <TitleUi title='Cambios a estos Términos y Condiciones'/>
                    </Grid>
                    <Grid item xs={12}>
                        <Typography>
                    ...
                    <Grid item xs={12}>
                        <Typography>
                            • Por número de teléfono: (614) 216-14-58
                        </Typography>
                    </Grid>
