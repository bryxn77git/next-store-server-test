...
export const Navbar = () => {
    ...
    const { toggleSideMenu, toggleCategoriesMenu, isCategoriesMenuOpen, toggleCategoriesMenuClosed, categoriesMenu, getCategoriesMenu } = useContext( UiContext );
    ...
    const handleShowCategoriesMenu = async() => {        
            ...
            <NextLink href="/" passHref>
                <Link>
                    <CardMedia
                        ...
                        sx={{ width: 210, display: isSearchVisible ? 'none' : 'block' }}
                    />  
                </Link>
            </NextLink>         
